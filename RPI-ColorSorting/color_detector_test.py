...
while True:
    ...
    # Make mask of image, only showing color in between
    ...
    im2, redContours, hierarchy = cv2.findContours(redMask, cv2.RETR_TREE,
                                                   cv2.CHAIN_APPROX_SIMPLE)
    im2, blueContours, hierarchy = cv2.findContours(blueMask, cv2.RETR_TREE,
                                                    cv2.CHAIN_APPROX_SIMPLE)
