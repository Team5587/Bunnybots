...
while True:
  ...
  cv2.putText(frame,'Blue: ' + str(blue), (5,height-15), cv2.FONT_HERSHEY_SIMPLEX, .5, (255,0,0), 1, cv2.LINE_AA)
  cv2.putText(frame,'Red: ' + str(red), (100,height-15), cv2.FONT_HERSHEY_SIMPLEX, .5, (0,0,255), 1, cv2.LINE_AA)
